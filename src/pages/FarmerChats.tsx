      ...
      <main className="flex-1 pt-24 pb-12">
        <div className="container max-w-7xl space-y-6">
          <section>
            ...
            <p className="text-muted-foreground mt-1">Desktop shows split chat view. On mobile, tap a conversation to open a dedicated chat page.</p>
          </section>
          ...
          <section className="grid lg:grid-cols-[320px_1fr] gap-4">
                    ...
                    <button
                      ...
                      onClick={() => {
                        if (window.innerWidth < 1024) {
                          navigate(`${ROUTES.farmer.chats}/${order.id}`);
                          return;
                        }
                        setActiveOrderId(Number(order.id));
                      }}
            ...
            <section className="hidden lg:flex rounded-2xl border border-border bg-card h-[72vh] flex-col overflow-hidden">
              {!activeOrder && (
                  ...
                  <header className="border-b border-border px-4 py-3 bg-muted/30">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[11px] text-muted-foreground">Updates every 3s</span>
                      </div>
                    </div>
                  </header>
            ...
            <section className="lg:hidden rounded-2xl border border-border bg-card p-4 text-sm text-muted-foreground">
              Tap any conversation above to open its full chat page.
            </section>
          </section>
        </div>
      </main>
